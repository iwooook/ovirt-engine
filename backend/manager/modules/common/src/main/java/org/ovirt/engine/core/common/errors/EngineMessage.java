...
public enum EngineMessage {
    ...
    CLUSTER_CANNOT_UPDATE_CPU_WITH_LOWER_HOSTS(ErrorType.CONFLICT),
    ...
    HOT_PLUG_CPU_IS_NOT_SUPPORTED_FOR_UEFI(ErrorType.NOT_SUPPORTED),
    ...
    // Incremental backup
    CANNOT_START_BACKUP_VM_SHOULD_BE_IN_UP_STATUS(ErrorType.CONFLICT),
    ACTION_TYPE_FAILED_INCREMENTAL_BACKUP_DISABLED_FOR_DISKS(ErrorType.CONFLICT),
    CANNOT_START_BACKUP_ALREADY_IN_PROGRESS(ErrorType.CONFLICT),
    ...
    CANNOT_DELETE_NON_ROOT_CHECKPOINT(ErrorType.BAD_PARAMETERS);
