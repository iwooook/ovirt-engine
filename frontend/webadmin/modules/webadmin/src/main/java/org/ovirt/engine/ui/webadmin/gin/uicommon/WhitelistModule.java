...
public class WhitelistModule extends AbstractGinModule {
    ...
    public MainModelProvider<Whitelist, WhitelistListModel> getWhitelistListProvider(EventBus eventBus,
        ...
        MainViewModelProvider<Whitelist, WhitelistListModel> result =
                new MainViewModelProvider<Whitelist, WhitelistListModel>(eventBus, defaultConfirmPopupProvider) {
                    @Override
                    ...
                    public AbstractModelBoundPopupPresenterWidget<? extends ConfirmationModel, ?>
                        getConfirmModelPopup(WhitelistListModel source,
    ...
    */
    ...
    protected void configure() {
        ...
        bind(WhitelistMainSelectedItems.class).asEagerSingleton();
        /*
